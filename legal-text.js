...
export const PRIVACY = [
  ...
  ['Usage information (only if you choose to share)', [
    ...
    'If you share, we may receive: the features you have switched on, your age group (a range, never a date of birth) and your gender - only if you choose to give them, and you can share just the features without them - your plan (free or paid), app version, device type and operating system, and a random install identifier that is not linked to your identity.',
