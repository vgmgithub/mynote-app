  ...
  return Promise.all([
    ...
    root.appendChild(el('div', { class: 'onboard-scroll onboard-welcome' }, [
      ...
      el('div', { class: 'onboard-points' }, [
        ...
        point('\u{1F512}', 'Your money stays on your phone', 'No account or cloud. Only anonymous usage counts are sent, and you can switch them off.'),
        ...(isPaidPlan()
