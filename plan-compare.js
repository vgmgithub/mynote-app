...
export const compareRows = (freeCount, total) => [
  ...
  ['Update stocks: current price, units, avg price', 'Type by hand', 'Auto-fill', null,
    'Free Plan: on each stock you type the current price, units and average price by hand. Pro Plan: upload one screenshot and all three are filled in for you. Works with Paytm Money and Groww (current price only) for Indian stocks and INDmoney for US stocks; other apps are coming soon.'],
  ['Mutual fund NAV', 'Type by hand', 'One tap', null,
  ...
  ['Gold, silver and dollar rates', 'Type by hand', 'Auto daily', null,
